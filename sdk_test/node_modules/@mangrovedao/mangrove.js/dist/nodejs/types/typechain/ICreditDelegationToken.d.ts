...
export interface ICreditDelegationTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approveDelegation" | "balanceOf" | "borrowAllowance" | "delegationWithSig"): FunctionFragment;
...
export declare type BorrowAllowanceDelegatedEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber
], BorrowAllowanceDelegatedEventObject>;
export declare type BorrowAllowanceDelegatedEventFilter = TypedEventFilter<BorrowAllowanceDelegatedEvent>;
