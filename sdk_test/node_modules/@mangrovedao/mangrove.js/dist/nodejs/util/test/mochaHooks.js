...
const __1 = require("../../");
const node_1 = __importDefault(require("../../util/node"));
const util_1 = require("../../util");
const transparent_proxy_1 = __importDefault(require("transparent-proxy"));
const serverParams = {
    host: "127.0.0.1",
    port: 8545,
    pipe: false,
...
exports.mochaHooks = {
    async beforeAll() {
        this.server = await (0, node_1.default)(serverParams).connect();
        this.accounts = {
        ...
        const provider = new ethers_1.ethers.providers.JsonRpcProvider(this.server.url);
        const mgv = await __1.Mangrove.connect({
            provider,
        ...
        await mgv.contract
            ...
            .then((tx) => tx.wait());
        await tokenA.contract.mint(this.accounts.tester.address, mgv.toUnits(10, 18));
        await tokenB.contract.mint(this.accounts.tester.address, mgv.toUnits(10, 18));
    ...
    async beforeEach() {
        ...
        if (currentProxy) {
            ...
            const closedDeferred = new util_1.Deferred();
        ...
        currentProxyPort++;
        newProxy.proxyServer = new transparent_proxy_1.default({
